...
export function registerEmailAuthRoutes(
    ...
    app.post('/auth/resend-verification', async (request) => {
          ...
          void mailer.send({
                  ...
                  html: `<p>Klik <a href="${verifyUrl}">di sini</a> untuk memverifikasi email Anda. Link berlaku 24 jam.</p>`,
                  locale: 'id',
                }).catch(() => {});
    ...
    app.post('/auth/forgot-password', async (request) => {
          ...
          if (user && mailer) {
                  ...
                  void mailer.send({
                            ...
                            html: `<p>Klik <a href="${resetUrl}">di sini</a> untuk mereset password Anda. Link berlaku 1 jam.</p>`,
                            locale: 'id',
                          }).catch(() => {});
                }
